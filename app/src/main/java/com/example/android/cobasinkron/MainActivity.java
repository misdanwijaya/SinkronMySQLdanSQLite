...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userList.size() != 0) {
            ...
            ListAdapter adapter = new SimpleAdapter(MainActivity.this, userList, R.layout.view_user_entry, new String[] {
                    "transaksiId", "transaksiName" }, new int[] { R.id.userId, R.id.userName });
    ...
    public void syncSQLiteMySQLDB() {
        ...
        client.post("http://sipeja.pe.hu/mysqlsqlitesync/getusers.php", params, new AsyncHttpResponseHandler() {
            @Override
    ...
    public void updateMySQLSyncSts(String json) {
        ...
        client.post("http://sipeja.pe.hu/mysqlsqlitesync/updatesyncsts.php", params, new AsyncHttpResponseHandler() {
            @Override
            public void onSuccess(String response) {
